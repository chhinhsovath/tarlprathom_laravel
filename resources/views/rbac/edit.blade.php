    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('rbac.update', $user) }}" enctype="multipart/form-data" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">{{ __('rbac.Leave blank to keep current password') }}</p>
                            ...
                            <div>
                                ...
                                <select id="sex" name="sex" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    ...
                                    <option value="M" {{ old('sex', $user->sex) === 'M' ? 'selected' : '' }}>{{ __('rbac.Male') }}</option>
                                    <option value="F" {{ old('sex', $user->sex) === 'F' ? 'selected' : '' }}>{{ __('rbac.Female') }}</option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="is_active" name="is_active" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option value="1" {{ old('is_active', $user->is_active ? '1' : '0') === '1' ? 'selected' : '' }}>{{ __('rbac.Active') }}</option>
                                    <option value="0" {{ old('is_active', $user->is_active ? '1' : '0') === '0' ? 'selected' : '' }}>{{ __('rbac.Inactive') }}</option>
                                </select>
                                    ...
                                    @foreach($schools as $school)
                                        <label class="flex items-center">
                                            <input type="checkbox" name="assigned_schools[]" value="{{ $school->id }}" 
                                                   {{ in_array($school->id, old('assigned_schools', $assignedSchools)) ? 'checked' : '' }}
                    ...
                    <div class="mb-8 border-t pt-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="province" class="block mt-1 w-full" type="text" name="province" :value="old('province', $user->province)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="district" class="block mt-1 w-full" type="text" name="district" :value="old('district', $user->district)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="commune" class="block mt-1 w-full" type="text" name="commune" :value="old('commune', $user->commune)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="village" class="block mt-1 w-full" type="text" name="village" :value="old('village', $user->village)" />
                    ...
                    <div class="mb-8 border-t pt-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="holding_classes" class="block mt-1 w-full" type="text" name="holding_classes" :value="old('holding_classes', $user->holding_classes)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="assigned_subject" class="block mt-1 w-full" type="text" name="assigned_subject" :value="old('assigned_subject', $user->assigned_subject)" />
                    ...
                    <div class="flex items-center justify-end space-x-4 border-t pt-8">
                        <a href="{{ route('rbac.show', $user) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                            {{ __('rbac.Cancel') }}
                        </a>
                        <x-primary-button>
                            {{ __('rbac.Update') }}
