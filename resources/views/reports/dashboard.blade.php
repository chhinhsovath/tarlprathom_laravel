                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">{{ number_format($data['summary_stats']['total_students']) }}</dd>
                                <dd class="text-sm text-green-600">{{ number_format($data['summary_stats']['active_students']) }} {{ __('active') }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">{{ number_format($data['summary_stats']['average_attendance'], 1) }}%</dd>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">{{ number_format($data['summary_stats']['assessments_completed']) }}</dd>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">{{ number_format($data['summary_stats']['students_needing_intervention']) }}</dd>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('reports.export', ['type' => 'at_risk', 'format' => 'excel']) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        {{ __('Export') }}
                    </a>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(enrollmentCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: Object.values(@json($data['enrollment_trends'] ?? [])).map(d => d.active),
                borderColor: 'rgb(59, 130, 246)',
                backgroundColor: 'rgba(59, 130, 246, 0.1)',
                tension: 0.1
            }, {
                label: 'Dropped Out',
                data: Object.values(@json($data['enrollment_trends'] ?? [])).map(d => d.dropped_out),
    ...
    new Chart(assessmentCtx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Average Score',
                data: Object.keys(['baseline', 'midline', 'endline']).map(cycle => 
