                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('schools.update', $school) }}" id="schoolForm" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="school_name" name="school_name" type="text" class="mt-1 block w-full" :value="old('school_name', $school->name)" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="province" name="province" type="text" class="mt-1 block w-full" :value="old('province', $school->province)" required />
